  ...
  item1 = list(
    ...
    html = shiny::tagList(
      ...
      shiny::tags$p(
        ...
        shinyMobile::f7Link(label = "here", href = "https://www.openicpsr.org/openicpsr/project/195447/version/V2/view?path=/openicpsr/195447/fcr:versions/V2/2023-DRS-Results-Summary-Report.pdf&type=file"),
        '.'
      ),
    )  # END tagList
  ),
